...
/**
 * The Phone Button from the navbar
...
class PhoneItem extends React.Component {
    ...
    createRoom = () => {
        ...
        // tells the server to create a room
        socket.emit(`web | create room`, {userCredentials : user.getCredentials(), type : 'local'}, this.createRoomResponse);
    }
    ...
    render () {
        ...
        return (
            <div
                className={`navbar-item phone-item-container${activeCssClass}`}
            ...
            >
             ...
             <div className="navbar-item-name">Play with Friends</div>
            </div>
        );
    }
